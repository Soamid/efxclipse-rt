...
public class StyledTextArea extends Control {
    ...
    @NonNull
    private final IntegerProperty scrollbarWidthProperty = new SimpleIntegerProperty(this, "scrollbarWidth", ScrollbarPane.DEFAULT_SCROLLBAR_WIDTH);

    public void setScrollbarWidth(int scrollbarWidth) {
        scrollbarWidthProperty.set(scrollbarWidth);
    }

    public IntegerProperty scrollbarWidthProperty() {
        return scrollbarWidthProperty;
    }
    ...
    public StyledTextArea() {
        ...
        scrollbarWidthProperty().addListener((observable, oldValue, newValue) -> ((StyledTextSkin) getSkin()).setScrollBarWidth(newValue.intValue()));
    }
     ...
     * </p>
     *
     * @param lineRulerVisible the new state
     */
     ...
     * @param selection <code>true</code> to update the current selection
     ...
     * @param start         the start
     * @param length        the length
     * @param includeRanges include ranges
     * @return the ranges
     */
     ...
     *
     * @param offset       the offset
     * @param locationHint hint for y coordinate relative to line
     * @return the point
     */
     ...
     *
     * @param advance the number of chars
     * @since 2.4.0
     */
     ...
     * </p>
     *
     * @param insertSpacesForTab <code>true</code> to turn on the replacement
     * @since 2.4.0
     */
